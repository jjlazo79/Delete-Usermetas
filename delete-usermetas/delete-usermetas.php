...
function delumet_options_page() {
    if ( isset($_POST['send_reset']) ) {
        ...
        // } else {
        //     echo '<div class="notice notice-error is-dismissible"><p>'.__('Bad dog! No biscuit', 'delete-usermetas').'</p></div>';
        // }
                ...
                <table class="form-table">
                    <tbody>
                        ...
                        <!-- <tr class="">
                            ...
                            <td>
                                <input class="regular-text" type="text" id="user_pass" name="user_pass" value="">
                                <br>
                                <span class="description">Contrase̱a para resetear los valores de un usermeta.</span>
                            </td>
                        </tr> -->
                    </tbody>
                </table>
